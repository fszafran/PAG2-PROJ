...
def ABCDEF_1():
    ...
    AB = Edge(2, A.id, B.id, euclidean_distance(A,B), 0,0)
...
def ABCDEF_2():
    ...
    AB = Edge(2, A.id, B.id, euclidean_distance(A,B), 100,0)
...
def GHIJK_1():
    ...
    JK = Edge(5, J.id, K.id, euclidean_distance(J,K), 0, 0) # najwieksza liczba atrakcji w zbiorze
